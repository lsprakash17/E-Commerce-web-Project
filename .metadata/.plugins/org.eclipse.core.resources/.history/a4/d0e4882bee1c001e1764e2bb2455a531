			...
			<div class="col-md">
				<form action="/merchant/signup" method="post"
					...
					<div class="form-group">
						...
						<div class="form-group">
						<label id="words_1" for="exampleInputPassword">Date of Birth</label>
						 <input type="date" class="form-control"
							id="exampleInputdob" aria-describedby="dobeHelp"
							name="date"> <small
							id="dobeHelp" class="form-text text-muted"></small>
					</div>
					Gender:
					<input type="radio" name="gender" value="male">Male
					<input type="radio" name="gender" value="female">FeMale<br>
					Pictuer:<input type="file" name="pic"><br> 
					<label id="words_1" for="exampleInputPassword">Address</label>
